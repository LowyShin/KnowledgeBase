...
$tempCsvFilePath = "$currentDirectory\deleteuser-mssql-temp.csv"
$tempCsvFilePath02 = "$currentDirectory\deleteuser-mssql-temp02.csv"

# Path to the final CSV file without quotation marks
$finalCsvFilePath = "$currentDirectory\deleteuser-mssql-gen.bat"
