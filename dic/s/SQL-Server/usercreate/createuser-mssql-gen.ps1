...
$excelFilePath = "$currentDirectory\createuser-mssql.xlsx"

# Name of the sheet you want to convert
$sheetName = "Gen"

# Path to the temporary CSV file in the current directory
$tempCsvFilePath = "$currentDirectory\createuser-mssql-temp.csv"
$tempCsvFilePath02 = "$currentDirectory\createuser-mssql-temp02.csv"

# Path to the final CSV file without quotation marks
$finalCsvFilePath = "$currentDirectory\createuser-mssql-gen.bat"
